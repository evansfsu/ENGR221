...
class GameData:
    ...
    ##########################
    # LAB 10 additions by EVAN #
    ##########################
    def getSnakeCells(self):
        """ Return the cells occupied by the snake """
    ...
    def moveSnake(self, nextCell):
        ...
        # Change the current tail to an empty cell
        tail = self.getSnakeTail()
        tail.becomeEmpty()
        self.__snakeCells.remove(tail)
    ...
    def getNorthNeighbor(self, cell): 
        ...
        return self.__board[cell.getRow()-1][cell.getCol()]
    ...
    def getEastNeighbor(self, cell):
        ...
        return self.__board[cell.getRow()][cell.getCol()+1]
    ...
    def getNextCellInDir(self):
        ...
        return {
            self.SnakeMode.GOING_NORTH : self.getHeadNorthNeighbor(),
            self.SnakeMode.GOING_SOUTH : self.getHeadSouthNeighbor(),
            self.SnakeMode.GOING_EAST : self.getHeadEastNeighbor(),
            self.SnakeMode.GOING_WEST : self.getHeadWestNeighbor()
        }.get(self.__currentMode)
